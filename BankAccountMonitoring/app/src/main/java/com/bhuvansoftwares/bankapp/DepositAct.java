...
public class DepositAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDeposit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(editAmount.getText().toString().length()>=3) {
                    if (accno.length() > 0) {
                        if (myDB.newTransaction(accno, editAmount.getText().toString(), 1,"DEPOSIT")) {
                    ...
                    mesage("Deposit should be 100 or more");
            }
        });
        ...
        public void mesage(String msg) {
            AlertDialog.Builder builder1 = new AlertDialog.Builder(DepositAct.this);
        ...
        {
            generateNotification(getApplicationContext(),"Your A/C is Credit with Rs."+editAmount.getText().toString()+".00 through Deposit. ","Depost Success");
        }
